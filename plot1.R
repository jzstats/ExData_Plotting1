...
# DESCRIPTION:  The script 'plot1.R',
#               constructs and saves a histogram
#               of the 'Global_active_power' variable over a selected 2-day period,
...
#
#               Plot 1, is created with the following 4 steps:
#                 1. Downloads and extracts the data file if missing
#                 2. Loads in R, part of the data file:
#                     'household_power_consumption.txt'
#                 3. Subsets the variable needed to construct 'plot1.png'
#                 4. Constructs Plot 1 and saves it
...
################################################################################
# STEP 3: Subsets the variable needed to construct 'plot1.png'
################################################################################
...
################################################################################
# STEP 4: Constructs Plot 1 and saves it as 'plot1.png' in the working directory
################################################################################
