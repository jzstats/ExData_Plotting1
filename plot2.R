...
# DESCRIPTION:  The script 'plot2.R',
...
#
#               Plot 2, is created with the following 4 steps:
...
#                    to construct 'plot2.png'
#                 4. Constructs Plot 2 and saves it
...
################################################################################
# STEP 3: Creates a data frame with the data needed to construct 'plot2.png'
################################################################################
...
################################################################################
# STEP 4: Constructs Plot 2 and saves it as 'plot2.png' in the working directory
################################################################################
